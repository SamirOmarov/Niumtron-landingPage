<template>
    <fragment>
        ...
        <c-clients bottom-divider />
        <c-team class="illustration-section-03" />

        <c-generic-section top-divider class="illustration-section-04">
        ...
        <c-generic-section top-divider class="illustration-section-05">
            <div class="container-xs">
        ...
        <c-generic-section top-divider class="center-content illustration-section-07">
            <div class="container">
        ...
        <c-cta top-divider class="illustration-section-06" />
    </fragment>
</template>
